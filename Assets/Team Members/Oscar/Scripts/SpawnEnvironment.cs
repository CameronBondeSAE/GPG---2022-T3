...
namespace Oscar
{
    public class SpawnEnvironment : MonoBehaviour
    {
        ...
        public void SpawnTheEnvironment(Vector3 prefabPosition, int amount, float scale)
        {
            ...
            firstWall.transform.localScale = new Vector3(1, prefabPosition.y * scale * 4, prefabPosition.z + 2);
            //firstWall.transform.SetParent(borderParent.transform);7
            ...
            secondWall.transform.localScale = new Vector3(prefabPosition.x + 2,prefabPosition.y * scale * 4,1);
            ...
            thirdWall.transform.localScale = new Vector3(1, prefabPosition.y * scale * 4, prefabPosition.z + 2);
            ...
            fourthWall.transform.localScale = new Vector3(prefabPosition.x + 2, prefabPosition.y * scale * 4, 1);
